...
|                         | This                                                                     | [Texnist/<br>MagicaVoxel_Importer](https://github.com/Texnist/MagicaVoxel_Importer)                                | [RichysHub/<br>MagicaVoxel-VOX-importer](https://github.com/RichysHub/MagicaVoxel-VOX-importer) | [ldo/<br>blender_magivox_import](https://github.com/ldo/blender_magivox_import) |
|------------------------:|--------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|
|                  Active | ✅                                                                        | ❌ [[ref]](https://github.com/Texnist/MagicaVoxel_Importer/issues/2#issuecomment-1020678306) Last update 25.12.2023 | ❌ Last update 13.04.2022                                                                        | ❌ Last update 06.07.2021                                                        |
|   Supported VOX version | 150, 200                                                                 | 200                                                                                                                | 150                                                                                             | 150                                                                             |
|               Hierarchy | ✅                                                                        | ✅                                                                                                                  | ❌                                                                                               | ❌                                                                               |
|                Material | ✅ (MATT, MATL)                                                           | ✅ (MATL)                                                                                                           | ~ (MATT)                                                                                        | ~ (MATT)                                                                        |
